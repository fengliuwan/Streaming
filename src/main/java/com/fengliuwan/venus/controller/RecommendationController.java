...
import com.fengliuwan.venus.service.RecommendationException;
import com.fengliuwan.venus.service.RecommendationService;
...
public class RecommendationController {
    ...
    // game controller used response.getWriter().print(new ObjectMapper().writeValueAsString(data));
    // same as @ResponseBody??
    @ResponseBody
